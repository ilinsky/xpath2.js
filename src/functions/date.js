...
fXPath2StaticContext_defineSystemFunction("years-from-duration",	[[cXSDuration, '?']],	function(oSequence1) {
	return fFunctionCall_duration_getComponent(oSequence1, "year");
});

// fn:months-from-duration($arg as xs:duration?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("months-from-duration",	[[cXSDuration, '?']],	function(oSequence1) {
	return fFunctionCall_duration_getComponent(oSequence1, "month");
});

// fn:days-from-duration($arg as xs:duration?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("days-from-duration",	[[cXSDuration, '?']],	function(oSequence1) {
	return fFunctionCall_duration_getComponent(oSequence1, "day");
});

// fn:hours-from-duration($arg as xs:duration?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("hours-from-duration",	[[cXSDuration, '?']],	function(oSequence1) {
	return fFunctionCall_duration_getComponent(oSequence1, "hours");
});

// fn:minutes-from-duration($arg as xs:duration?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("minutes-from-duration",	[[cXSDuration, '?']],	function(oSequence1) {
	return fFunctionCall_duration_getComponent(oSequence1, "minutes");
});

// fn:seconds-from-duration($arg as xs:duration?) as xs:decimal?
fXPath2StaticContext_defineSystemFunction("seconds-from-duration",	[[cXSDuration, '?']],	function(oSequence1) {
	return fFunctionCall_duration_getComponent(oSequence1, "seconds");
});

// functions on dateTime
// fn:year-from-dateTime($arg as xs:dateTime?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("year-from-dateTime",		[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1,	"year");
});

// fn:month-from-dateTime($arg as xs:dateTime?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("month-from-dateTime",		[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "month");
});

// fn:day-from-dateTime($arg as xs:dateTime?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("day-from-dateTime",			[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "day");
});

// fn:hours-from-dateTime($arg as xs:dateTime?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("hours-from-dateTime",		[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "hours");
});

// fn:minutes-from-dateTime($arg as xs:dateTime?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("minutes-from-dateTime",		[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "minutes");
});

// fn:seconds-from-dateTime($arg as xs:dateTime?) as xs:decimal?
fXPath2StaticContext_defineSystemFunction("seconds-from-dateTime",		[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "seconds");
});

// fn:timezone-from-dateTime($arg as xs:dateTime?) as xs:dayTimeDuration?
fXPath2StaticContext_defineSystemFunction("timezone-from-dateTime",	[[cXSDateTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "timezone");
});

// functions on date
// fn:year-from-date($arg as xs:date?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("year-from-date",	[[cXSDate, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "year");
});

// fn:month-from-date($arg as xs:date?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("month-from-date",	[[cXSDate, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "month");
});

// fn:day-from-date($arg as xs:date?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("day-from-date",		[[cXSDate, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "day");
});

// fn:timezone-from-date($arg as xs:date?) as xs:dayTimeDuration?
fXPath2StaticContext_defineSystemFunction("timezone-from-date",	[[cXSDate, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "timezone");
});

// functions on time
// fn:hours-from-time($arg as xs:time?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("hours-from-time",		[[cXSTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "hours");
});

// fn:minutes-from-time($arg as xs:time?) as xs:integer?
fXPath2StaticContext_defineSystemFunction("minutes-from-time",		[[cXSTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "minutes");
});

// fn:seconds-from-time($arg as xs:time?) as xs:decimal?
fXPath2StaticContext_defineSystemFunction("seconds-from-time",		[[cXSTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "seconds");
});

// fn:timezone-from-time($arg as xs:time?) as xs:dayTimeDuration?
fXPath2StaticContext_defineSystemFunction("timezone-from-time",	[[cXSTime, '?']],	function(oSequence1) {
	return fFunctionCall_dateTime_getComponent(oSequence1, "timezone");
});
...
fXPath2StaticContext_defineSystemFunction("adjust-dateTime-to-timezone",	[[cXSDateTime, '?'], [cXSDayTimeDuration, '?', true]],	function(oSequence1, oSequence2) {
...
fXPath2StaticContext_defineSystemFunction("adjust-date-to-timezone",		[[cXSDate, '?'], [cXSDayTimeDuration, '?', true]],	function(oSequence1, oSequence2) {
	if (oSequence1.isEmpty())
		return null;
	//
	return fFunctionCall_dateTime_adjustTimezone(oSequence1.items[0], arguments.length > 1 && oSequence2.isEmpty() ? null : arguments.length > 1 ? oSequence2.items[0] : this.timezone);
...
fXPath2StaticContext_defineSystemFunction("adjust-time-to-timezone",		[[cXSTime, '?'], [cXSDayTimeDuration, '?', true]],	function(oSequence1, oSequence2) {
	if (oSequence1.isEmpty())
		return null;
	//
	return fFunctionCall_dateTime_adjustTimezone(oSequence1.items[0], arguments.length > 1 && oSequence2.isEmpty() ? null : arguments.length > 1 ? oSequence2.items[0] : this.timezone);
